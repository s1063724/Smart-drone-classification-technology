...
#ifndef TELLO_MSGS__MSG__FLIGHT_DATA__STRUCT_H_
#define TELLO_MSGS__MSG__FLIGHT_DATA__STRUCT_H_
...
typedef struct tello_msgs__msg__FlightData
{
  ...
  rosidl_generator_c__String raw;
  uint8_t sdk;
  int32_t pitch;
  int32_t roll;
  int32_t yaw;
...
#endif  // TELLO_MSGS__MSG__FLIGHT_DATA__STRUCT_H_
