...
#ifndef TELLO_MSGS__MSG__TELLO_RESPONSE__FUNCTIONS_H_
#define TELLO_MSGS__MSG__TELLO_RESPONSE__FUNCTIONS_H_
...
#endif  // TELLO_MSGS__MSG__TELLO_RESPONSE__FUNCTIONS_H_
