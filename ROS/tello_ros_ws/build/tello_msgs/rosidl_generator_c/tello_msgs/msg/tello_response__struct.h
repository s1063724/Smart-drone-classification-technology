...
#ifndef TELLO_MSGS__MSG__TELLO_RESPONSE__STRUCT_H_
#define TELLO_MSGS__MSG__TELLO_RESPONSE__STRUCT_H_
...
{
  uint8_t rc;
  rosidl_generator_c__String str;
...
#endif  // TELLO_MSGS__MSG__TELLO_RESPONSE__STRUCT_H_
