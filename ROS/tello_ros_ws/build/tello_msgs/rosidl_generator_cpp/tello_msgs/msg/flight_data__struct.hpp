...
#ifndef TELLO_MSGS__MSG__FLIGHT_DATA__STRUCT_HPP_
#define TELLO_MSGS__MSG__FLIGHT_DATA__STRUCT_HPP_
...
struct FlightData_
{
  ...
  explicit FlightData_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init)
  {
  ...
  explicit FlightData_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
    raw(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
...
#endif  // TELLO_MSGS__MSG__FLIGHT_DATA__STRUCT_HPP_
