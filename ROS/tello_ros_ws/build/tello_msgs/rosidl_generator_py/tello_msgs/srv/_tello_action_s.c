...
bool tello_msgs__srv__tello_action__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tello_msgs.srv._tello_action.TelloAction_Request",
  ...
  {  // cmd
    ...
    rosidl_generator_c__String__assign(&ros_message->cmd, PyBytes_AS_STRING(encoded_field));
...
bool tello_msgs__srv__tello_action__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tello_msgs.srv._tello_action.TelloAction_Response",
