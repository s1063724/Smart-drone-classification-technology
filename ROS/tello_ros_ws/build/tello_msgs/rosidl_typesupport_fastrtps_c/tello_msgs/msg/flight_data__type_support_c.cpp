...
#include "tello_msgs/msg/flight_data__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/string.h"  // raw
#include "rosidl_generator_c/string_functions.h"  // raw
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: raw
  {
    const rosidl_generator_c__String * str = &ros_message->raw;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: raw
  {
    ...
    if (!ros_message->raw.data) {
      rosidl_generator_c__String__init(&ros_message->raw);
    }
