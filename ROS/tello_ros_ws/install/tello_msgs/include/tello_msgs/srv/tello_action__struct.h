...
#ifndef TELLO_MSGS__SRV__TELLO_ACTION__STRUCT_H_
#define TELLO_MSGS__SRV__TELLO_ACTION__STRUCT_H_
...
{
  rosidl_generator_c__String cmd;
...
#endif  // TELLO_MSGS__SRV__TELLO_ACTION__STRUCT_H_
