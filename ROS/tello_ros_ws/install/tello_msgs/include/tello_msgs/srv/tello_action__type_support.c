...
#include <stddef.h>
#include "tello_msgs/srv/tello_action__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers tello_msgs__srv__tello_action__rosidl_typesupport_introspection_c__TelloAction_service_members = {
  "tello_msgs__srv",  // service namespace
  "TelloAction",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // tello_msgs__srv__tello_action__rosidl_typesupport_introspection_c__TelloAction_Request_message_type_support_handle,
  NULL  // response message
  // tello_msgs__srv__tello_action__rosidl_typesupport_introspection_c__TelloAction_Response_message_type_support_handle
};

static rosidl_service_type_support_t tello_msgs__srv__tello_action__rosidl_typesupport_introspection_c__TelloAction_service_type_support_handle = {
  0,
  &tello_msgs__srv__tello_action__rosidl_typesupport_introspection_c__TelloAction_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tello_msgs, srv, TelloAction)() {
  if (!tello_msgs__srv__tello_action__rosidl_typesupport_introspection_c__TelloAction_service_type_support_handle.typesupport_identifier) {
    tello_msgs__srv__tello_action__rosidl_typesupport_introspection_c__TelloAction_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)tello_msgs__srv__tello_action__rosidl_typesupport_introspection_c__TelloAction_service_type_support_handle.data;
  ...
  return &tello_msgs__srv__tello_action__rosidl_typesupport_introspection_c__TelloAction_service_type_support_handle;
}
